...
const handlesignupformsubmit=(e,signupformsubmitresult)=>{
    e.preventDefault();
    ...
    //qs kullanmak için önce npm i qs yazarak indirmek gerekiyor.qs kullanmayınca veriler api'ya null gidiyor
     ...
     axios.post("/users/adduser",qs.stringify({name:name,surname:surname,username:username,password:password}))
  ...
  return (
    <div style={{display:"flex",justifyContent:"center"}}>
        ...
        <Form onSubmit={e=>handlesignupformsubmit(e,signupformsubmitresult)}>
